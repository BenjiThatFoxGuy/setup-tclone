...
Invoke-WebRequest $env:GITHUB_SERVER_URL/tgdrive/rclone/releases/download/$env:version/rclone-$env:version-windows-amd64.zip -OutFile rclone-$env:version-windows-amd64.zip
